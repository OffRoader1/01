...
def ReadImage(InputImagePath):
    ...
    if os.path.isfile(InputImagePath):						    # If path is of file.
        ...
        InputImage = cv2.resize(InputImage,(192*5,108*5))
...
if __name__ == "__main__":
    Images, ImageNames = ReadImage("E://SRT//pointTest//0586.jpg")            # Reading all input images
    for i in range(len(Images)):
        ...
        print(VanishingPoint[0]*2,(108*5-VanishingPoint[1])*2)
